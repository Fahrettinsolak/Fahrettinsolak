...
// line 2 "model.ump"
// line 108 "model.ump"
public class HospitalWards extends Hospital
{

  public HospitalWards(String aName, String aAddress, String aPhone) {
...
//------------------------
  ...
  //HospitalWards Attributes
  private String name;
  private String address;
  private String phone;

  //HospitalWards Associations
  ...
  public boolean addTeam(Team aTeam)
  {
    ...
    HospitalWards existingHospitalWards = aTeam.getHospitalWards();
    boolean isNewHospitalWards = existingHospitalWards != null && !this.equals(existingHospitalWards);

    if (isNewHospitalWards && existingHospitalWards.numberOfTeams() <= minimumNumberOfTeams())
    {
      return wasAdded;
    }
    if (isNewHospitalWards)
    {
      aTeam.setHospitalWards(this);
    }
    else
    {
      teams.add(aTeam);
  ...
  public boolean removeTeam(Team aTeam)
  {
    ...
    //Unable to remove aTeam, as it must always have a hospitalWards
    if (this.equals(aTeam.getHospitalWards()))
    {
      return wasRemoved;
    }

    //hospitalWards already at minimum (1)
  ...
  public boolean addWard(Ward aWard)
  {
    ...
    HospitalWards existingHospitalWards = aWard.getHospitalWards();
    boolean isNewHospitalWards = existingHospitalWards != null && !this.equals(existingHospitalWards);
    if (isNewHospitalWards)
    {
      aWard.setHospitalWards(this);
    }
    else
    {
      wards.add(aWard);
  ...
  {
    boolean wasRemoved = false;
    //Unable to remove aWard, as it must always have a hospitalWards
    if (!this.equals(aWard.getHospitalWards()))
    {
      wards.remove(aWard);
      wasRemoved = true;
    }
