...
namespace ce205_hw4_gui
{
    ...
    {
        public NodeRB root;
        public List<RBline> line = new List<RBline>();
        public List<RBCircle> circle = new List<RBCircle>();
        ...
        public void addlingkaran(ref NodeRB root)
        {
            ...
            if (root.passed)
            {
                circle.Add(new RBCircle(root.x, root.y, root.value.ToString(), Color.Yellow));
            }
            else
            {
                circle.Add(new RBCircle(root.x, root.y, root.value.ToString(), root.color));
            }
        }
        ...
        public void addgaris(ref NodeRB root)
        {
            if (root != null)
            {
                if (root.left != null)
                {
                    ...
                    {
                        line.Add(new RBline(root.x + 15, root.y + 15, root.left.x + 15, root.left.y + 15, Color.Yellow));
                    }
                    else
                    {
                        line.Add(new RBline(root.x + 15, root.y + 15, root.left.x + 15, root.left.y + 15, Color.Black));
                    }
                }
                ...
                if (root.right != null)
                {
                    ...
                    {
                        line.Add(new RBline(root.x + 15, root.y + 15, root.right.x + 15, root.right.y + 15, Color.Yellow));
                    }
                    else
                    {
                        line.Add(new RBline(root.x + 15, root.y + 15, root.right.x + 15, root.right.y + 15, Color.Black));
                    }
                }
